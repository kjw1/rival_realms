...
-record(state, {game, cur_player = 1}).
...
init([]) ->
  rr_game:init_rand(),
  Game = rr_game:new_game(),
  {ok, renew, #state{game=Game}}.
...
%% @end
%%--------------------------------------------------------------------
renew({CurPlayer, end_renew}, _From, #state{cur_player= CurPlayer} = State) ->
...
%% @end
%%--------------------------------------------------------------------
handle_sync_event({Player, play_card, From, To}, 
                  _From,
                  Phase,
